...
export const errors = {
  ...
  [ClaimErr.CREATE_CLAIM_FORBIDDEN_ERROR]: 'Failed to create ticket, forbidden',
  ...
  [ClaimErr.UPDATE_CLAIM_FORBIDDEN_ERROR]: 'Failed to update ticket, forbidden',
  ...
  [ClaimErr.REFUND_CLAIM_FORBIDDEN_ERROR]: 'Failed to refund ticket, forbidden',
  ...
  [ClaimErr.REPLY_CLAIM_FORBIDDEN_ERROR]: 'Failed to reply ticket, forbidden',
  [ClaimErr.REPLY_CLAIM_NOT_FOUND_ERROR]: 'Failed to reply ticket, not found',

  [ClaimErr.FIND_CLAIM_BY_FAILED]: 'Failed to find ticket',
  [ClaimErr.FIND_CLAIM_BY_FORBIDDEN_ERROR]: 'Failed to find ticket, forbidden',
