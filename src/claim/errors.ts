...
export enum ClaimErr {
  ...
  GET_ALL_CLAIM_FAILED = 'claim/get-all-claim',
  GET_ALL_CLAIM_FORBIDDEN = 'claim/get-all-claim-forbidden',
...
export const errors = {
  ...
  [ClaimErr.GET_ALL_CLAIM_FAILED]: 'Failed to get all claim tickets',
  [ClaimErr.GET_ALL_CLAIM_FORBIDDEN]:
