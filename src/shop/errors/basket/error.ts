...
export enum BasketErr {
  ...
  GET_BASKET_FAILED_FORBIDDEN = 'basket/get-basket-failed-forbidden',
  BASKET_ADD_FAILED = 'basket/basket-add-failed',
  BASKET_ADD_FAILED_FORBIDDEN = 'basket/add-failed-forbidden',
  BASKET_REMOVE_FAILED = 'basket/basket-remove-failed',
  BASKET_REMOVE_FAILED_FORBIDDEN = 'basket/remove-product-failed-forbidden',
  BASKET_CLEAR_FAILED = 'basket/basket-clear-failed',
  BASKET_CLEAR_FAILED_FORBIDDEN = 'basket/clear-failed-forbidden',
  BASKET_COMMENT_FAILED = 'basket/basket-comment-failed',
  BASKET_COMMENT_FAILED_FORBIDDEN = 'basket/basket-comment-failed-forbidden',
  VALIDATE_AND_PAY_BASKET_FAILED = 'basket/validate-and-pay-basket-failed',
  VALIDATE_AND_PAY_BASKET_FAILED_FORBIDDEN = 'basket/validate-and-pay-basket-failed-forbidden',
  BASKET_VALIDATE_PENDING_FAILED = 'basket/basket-validate-pending-failed',
  BASKET_VALIDATE_PENDING_FAILED_FORBIDDEN = 'basket/validate-pending-basket-failed-forbidden',
  BASKET_DISCOUNT_CODE_FAILED = 'basket/basket-discount-code-failed',
  BASKET_DISCOUNT_CODE_FAILED_FORBIDDEN = 'basket/apply-discount-code-failed-forbidden',
  BASKET_SPONSOR_CODE_FAILED = 'basket/apply-sponsor-discount-code-failed',
  BASKET_SPONSOR_CODE_FAILED_FORBIDDEN = 'basket/apply-sponsor-discount-code-failed-forbidden',
...
export const errors = {
  ...
  [BasketErr.BASKET_COMMENT_FAILED_FORBIDDEN]:
    'Failed to comment basket, forbidden',
