...
export enum PaymentErr {
  ...
  DELETE_CARD_FORBIDDEN = 'payment/delete-card-forbidden',
  REQUEST_CREDENTIALS_CARD_FAILED = 'payment/request-credentials-failed',
  REQUEST_CREDENTIALS_CARD_FORBIDDEN = 'payment/request-credentials-forbidden',
  SAVE_CARD_FAILED = 'payment/save-card-failed',
  SAVE_CARD_FORBIDDEN = 'payment/save-card-forbidden',
  SET_DEFAULT_CARD_FAILED = 'payment/set-default-card-failed',
  SET_DEFAULT_CARD_FORBIDDEN = 'payment/set-default-card-forbidden',
  VALIDATE_CARD_FAILED = 'payment/validate-card-failed',
  VALIDATE_CARD_FORBIDDEN = 'payment/validate-card-forbidden',
...
export const errors = {
  ...
  [PaymentErr.DELETE_CARD_FORBIDDEN]: 'Failed to delete card, forbidden',
  ...
  [PaymentErr.SAVE_CARD_FORBIDDEN]: 'Failed to save card, forbidden',
  [PaymentErr.SET_DEFAULT_CARD_FAILED]: 'Failed to set default card',
  [PaymentErr.SET_DEFAULT_CARD_FORBIDDEN]:
    'Failed to set default card, forbidden',
  [PaymentErr.VALIDATE_CARD_FAILED]: 'Failed to validate card',
  [PaymentErr.VALIDATE_CARD_FORBIDDEN]: 'Failed to validate card, forbidden',
