...
export enum CalendarErr {
  ...
  GET_CALENDAR_EVENTS_FOR_CURRENT_PERSON_FAILED_FORBIDDEN = 'calendar-event/get-failed-for-current-person-forbidden',
  ...
  GET_CALENDAR_EVENT_BY_ID_FAILED_FORBIDDEN = 'calendar-event/get-by-id-failed-forbidden',
  ...
  FIND_CALENDAR_AVAILABILITIES_FAILED_FORBIDDEN = 'calendar/get-availabilities-forbidden',

  GET_AVAILABILITIES_FOR_DATES_CALENDAR_FAILED = 'calendar/get-availabilities-for-dates-failed',
  GET_AVAILABILITIES_FOR_DATES_CALENDAR_FAILED_FORBIDDEN = 'calendar/get-availabilities-for-dates-forbidden',
  GET_AVAILABILITIY_FOR_LOCATION_CALENDAR_FAILED = 'calendar/get-availabilities-for-location-failed',
  GET_AVAILABILITIY_FOR_LOCATION_CALENDAR_FAILED_FORBIDDEN = 'calendar/get-availabilities-for-location-forbidden',

  CREATE_CALENDAR_FAILED = 'calendar/creation-failed',
  CREATE_CALENDAR_FAILED_FORBIDDEN = 'calendar/creation-failed-forbidden',
  ...
  DELETE_CALENDAR_FAILED_FORBIDDEN = 'calendar/delete-failed-forbidden',
  ...
  FIND_ONE_CALENDAR_FAILED_FORBIDDEN = 'calendar/find-one-failed-forbidden',
...
export const errors = {
  ...
  [CalendarErr.CREATE_CALENDAR_FAILED_FORBIDDEN]:
  ...
  [CalendarErr.DELETE_CALENDAR_FAILED_FORBIDDEN]:
