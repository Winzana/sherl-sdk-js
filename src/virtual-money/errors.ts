...
export enum VirtualMoneyErr {
  ...
  CREDIT_WALLET_FAILED_CMS_NOT_EXIST = 'virtual-money/credit-wallet-failed-cms-not-exist',
  ...
  CREDIT_WALLET_FAILED_FORBIDDEN = 'virtual-money/credit-wallet-failed-forbidden',
...
export const errors = {
  ...
  [VirtualMoneyErr.CREDIT_WALLET_FAILED_CMS_NOT_EXIST]: 'Wallet not exist',
