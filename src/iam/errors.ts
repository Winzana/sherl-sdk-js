...
export enum IamErr {
  ...
  IAM_PROFILE_NOT_FOUND = 'iam/fetch-failed-profile-not-found',
  IAM_GET_PROFILE_BY_ID_FORBIDDEN = 'iam/fetch-profile-by-id-failed-forbidden',
  IAM_ROLE_NOT_FOUND = 'iam/fetch-failed-role-not-found',
...
export const errors = {
  ...
  [IamErr.IAM_ROLE_NOT_FOUND]: 'Failed to fetch iam role, role not found',
