...
export enum BugReportsErr {
  ...
  CREATE_BUG_REPORT_NOT_FOUND = 'bug-reports/create-bug-report-not-found',
  GET_BUG_REPORTS_FAILED = 'bug-reports/get-bug-reports-failed',
  GET_BUG_REPORTS_FORBIDDEN = 'bug-reports/get-bug-reports-forbidden',
  GET_BUG_REPORTS_NOT_FOUND = 'bug-reports/get-bug-reports-not-found',
  ...
  GET_BUG_REPORT_BY_ID_NOT_FOUND = 'bug-reports/get-bug-report-by-id-not-found',
}
...
export const errors = {
  ...
  [BugReportsErr.CREATE_BUG_REPORT_NOT_FOUND]:
    'Failed to create bug report, not found',
  ...
  [BugReportsErr.GET_BUG_REPORTS_NOT_FOUND]:
    'Failed to get bug reports, not found',
  ...
  [BugReportsErr.GET_BUG_REPORT_BY_ID_NOT_FOUND]:
    'Failed to get bug report by id, not found',
};
